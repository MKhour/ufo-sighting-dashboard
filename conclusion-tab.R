...
conclusion_ui <- function() { 
    fluidPage(
      ...
      tags$ul(
        ...
        tags$li("The majority of sightings take place at night, morning, and less so at midday. At night it is much easier to see dully lit objects in the sky. Morning being more common than day is likely due to human activity such as commuting and airlines having most flights in the morning hours."),
        tags$li("The majority of sightings reported appear in urban cities, or areas with higher populations."),
        tags$li("While some words such as \"craft\" have consistently been used to describe UFOs, adjectives regarding their shape and color have changed over time."),
        tags$li("Sentiment around UFO sightings has become more positive over time.")
      )
    )
  )}
